...
package bbjxl.com.loading{
	...
	public class loading extends MovieClip {
		public static var SUBMAPLOADOVER:String = "submaploadover";//加载XML完毕
		...
		private var _my_subMap:Object;
		private var _my_mask:Object;
		private var _submap_mc:Object;
		
		public function get submap_mc():Object {
			return _submap_mc;
		}
		public function set submap_mc(setValue:Object):void {
			_submap_mc = setValue;
		}
		public function get my_subMap():Object {
			return _my_subMap;
		}
		public function set my_subMap(setValue:Object):void {
			_my_subMap = setValue;
		}
		public function get my_mask():Object {
			return _my_mask;
		}
		public function set my_mask(setValue:Object):void {
			_my_mask = setValue;
		}
		public function loading(__x:Number,__y:Number,__Str:String,__C) {
			my_Number_x=__x;
			my_Number_y=__y;
			my_load_Str=__Str;
			my_Choose=__C;
		...
		private function loadComplete(event:Event):void {
			...
			addChild(my_Loader);
			_my_subMap=MovieClip((my_Loader.content as Object).bg_mc);
			_my_mask=MovieClip((my_Loader.content as Object).mask_mc);
			_submap_mc=MovieClip((my_Loader.content as Object).submap_mc);
			//trace(_my_subMap);
			dispatchEvent(new Event("submaploadover"));//广播
		}
	}
}