package bbjxl.com.content.three{
	...
	**/
	...
	public class RMPX_BXS_FormBody extends RMPX_DHKG_FormBody {
		private var _currentFaultOption:uint;
		//===================================================================================================================//
		
		//===================================================================================================================//
		public function RMPX_BXS_FormBody(_xml:XML, _optionId:uint = 0) {
		...
		override protected function init():void {
			...
			//测量状态
			var h21:FormCell=new FormCell(thisXMl.state[0].@statename,formWidth,formHeight/2,0xF1F1F1,0x000000);
			if(!_exam){
				h21.x=h1.x+h1.width;
				}
			addChild(h21);
