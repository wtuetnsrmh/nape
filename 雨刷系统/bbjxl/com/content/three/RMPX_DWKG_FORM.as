package bbjxl.com.content.three{
	...
	**/
	...
	public class RMPX_DWKG_FORM extends Sprite {
		...
		//===================================================================================================================//
		public function RMPX_DWKG_FORM() {
			if (_singleton) {
		...
		public function examOver(opid:uint):void{
			...
			formBody = null;
			formBody=new RMPX_DWKG_FormBody(XML(_allXml.child(opid).toXMLString()),opid);
			//trace(_allXml)
		...
		public function updata(opid:uint):void {
			formBody = null;
			formBody=new RMPX_DWKG_FormBody(XML(_allXml.child(opid).toXMLString()));
			//trace(_allXml)
			CommonlyClass.cleaall(formBodySp);
			formBodySp.addChild(formBody);
			formBodySp.y=formHead.y+formHead.height;
		...
		protected function creaFormbody():void{
			formBody=new RMPX_DWKG_FormBody(_thisXml);
			formBodySp.addChild(formBody);
			formBodySp.y=formHead.y+formHead.height;
