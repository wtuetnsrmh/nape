package bbjxl.com.content.three{
	...
	**/
	...
	public class ThreeContectLine extends Sprite
	{
		...
		protected static var _instance:ThreeContectLine;
		//===================================================================================================================//
		public function get currentZPin():Pin
		{
			return _currentZPin;
		}
		public function get currentFPin():Pin
		{
			return _currentFPin;
		}
		...
		//===================================================================================================================//
		public function ThreeContectLine()
		{
			if (_singleton)
			{
		...
		public static function getInstance()
		{
			...
			{
				_singleton = false;
				_instance=new ThreeContectLine();
				
			}
			return _instance;
		}

		public function setParent(thisParent:DisplayObjectContainer):void
		{
