package bbjxl.com.content.three{
	...
	**/
	...
	public class RMPX_DWKG_FormBody extends RMPX_DHKG_FormBody {
		private var _currentFaultOption:uint;
		//===================================================================================================================//
		
		//===================================================================================================================//
		public function RMPX_DWKG_FormBody(_xml:XML, _optionId:uint = 0) {
		...
		override protected function init():void {
			_currentPartName = Gvar.DWKG;
			//故障名称
			//trace(thisXMl.attribute("_name"))
			var h1:FormCell=new FormCell(thisXMl.@faultname,formWidth,formHeight,0xF1F1F1,0x000000);
			if(!_exam)
			addChild(h1);
			
			//测量状态
			var h21:FormCell=new FormCell(thisXMl.state[0].@statename,formWidth,formHeight,0xF1F1F1,0x000000);
			if(!_exam){
				h21.x=h1.x+h1.width;
				}
			addChild(h21);
