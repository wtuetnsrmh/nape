package bbjxl.com.content.three{
	...
	**/
	...
	public class RMPX_Fault_Select extends Sprite {
		protected var _faultXml:XML=new XML();//故障数据XML
		protected var _optionSp:Sprite=new Sprite();//放选项的容器
		protected var _currentSelecteOptionIndex:uint=0;//当前选的选项
		...
		//===================================================================================================================//
		public function RMPX_Fault_Select(_xml:XML):void {
			addChild(_bg);
			addChild(_optionSp);
		...
		protected function creaBg():void{
			...
			//菜单标题
			var tmepText:CreaText=new CreaText("故障菜单",0xffffff,15,false,"left");
