...
package bbjxl.com.utils
{
	...
	public class MyScrollBar
	{
		...
		public function set mouseWheel($value:Boolean):void
		{
			...
			_parentMC.stage.addEventListener(MouseEvent.MOUSE_WHEEL, mouseWheelHandler);
			else if(_abled)
		...
		*/  
		public function MyScrollBar($target:DisplayObjectContainer, $maskTarget:*, $scrollBar:Sprite, $scrollLine:Sprite, $tween:Number = 5, $elastic:Boolean = false, $lineAbleClick:Boolean = false , $mouseWheel:Boolean = false, $direction:String = "L") 
		{
